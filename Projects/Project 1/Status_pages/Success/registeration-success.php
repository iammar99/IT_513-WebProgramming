...
<section
    ...
    <h2 class="text-3xl font-bold text-slate-800 mb-6 text-center">Registration Successful!</h2>
    ...
    <article class="bg-white shadow-md rounded-xl p-8 text-center w-full sm:w-10/12 lg:w-8/12">
        <div class="mb-6">
            ...
            <p class="text-gray-700 mb-2">Your account has been created successfully.</p>
            <p class="text-gray-600 mb-6">You can now log in and start using your account.</p>
        </div>
